...
4. Create a file in that folder. Name it `about.txt` and add a fun fact about yourself. (_You can use the command line: `touch about.txt`_ to create the file and _`echo 'Your fun fact` >> about.txt_)
